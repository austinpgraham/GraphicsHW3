...
@rem ##########################################################################
@rem
@rem  viewport2 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and VIEWPORT2_OPTS to pass JVM options to this script.
...
@rem Execute viewport2
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %VIEWPORT2_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.example.Viewport2 %CMD_LINE_ARGS%
...
:fail
rem Set variable VIEWPORT2_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%VIEWPORT2_EXIT_CONSOLE%" exit 1
exit /b 1
