...
@rem ##########################################################################
@rem
@rem  lorenz startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and LORENZ_OPTS to pass JVM options to this script.
...
@rem Execute lorenz
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LORENZ_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.example.Lorenz %CMD_LINE_ARGS%
...
:fail
rem Set variable LORENZ_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%LORENZ_EXIT_CONSOLE%" exit 1
exit /b 1
